...
For Assignment 3, I discuss about the existing problems that computer vision is facing and introducing some of the existings Generative Adversarial Net(GAN) such as Pix2pix GAN and CycleGAN to improve the problems. Furthermore, I also discuss about the correct metrics that we should be for different type of GAN.
